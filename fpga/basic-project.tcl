...
#
# basic-project.tcl: Tcl script for re-creating project 'basic-project'
#
# Generated by Vivado on Tue Oct 24 17:25:41 -0600 2023
...
#
# 1. This project restoration tcl script (basic-project.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/Ryan/projects/new-project/fpga/basic-project/basic-project.srcs/sources_1/bd/system/system.bd"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/Users/Ryan/projects/new-project/fpga/sources/vhdl/AXI_Parse.vhd"
#    "C:/Users/Ryan/projects/new-project/fpga/sources/vhdl/axis_red_pitaya_dac.vhd"
#    "C:/Users/Ryan/projects/new-project/fpga/sources/vhdl/AXIS_Red_Pitaya_ADC.vhd"
#    "C:/Users/Ryan/projects/new-project/fpga/sources/ip/BlockMemory/BlockMemory.xci"
#    "C:/Users/Ryan/projects/new-project/fpga/sources/vhdl/CustomDataTypes.vhd"
#    "C:/Users/Ryan/projects/new-project/fpga/sources/vhdl/AXI_Bus_Package.vhd"
#    "C:/Users/Ryan/projects/new-project/fpga/sources/vhdl/topmod.vhd"
#    "C:/Users/Ryan/projects/new-project/fpga/sources/system/system_wrapper.vhd"
#    "C:/Users/Ryan/projects/new-project/fpga/cfg/clocks.xdc"
#    "C:/Users/Ryan/projects/new-project/fpga/cfg/ports.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../new-project/fpga/basic-project/basic-project.srcs/sources_1/bd/system/system.bd"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../../new-project/fpga/sources/vhdl/AXI_Parse.vhd"]"\
 "[file normalize "$origin_dir/../../new-project/fpga/sources/vhdl/axis_red_pitaya_dac.vhd"]"\
 "[file normalize "$origin_dir/../../new-project/fpga/sources/vhdl/AXIS_Red_Pitaya_ADC.vhd"]"\
 "[file normalize "$origin_dir/../../new-project/fpga/sources/ip/BlockMemory/BlockMemory.xci"]"\
 "[file normalize "$origin_dir/../../new-project/fpga/sources/vhdl/CustomDataTypes.vhd"]"\
 "[file normalize "$origin_dir/../../new-project/fpga/sources/vhdl/AXI_Bus_Package.vhd"]"\
 "[file normalize "$origin_dir/../../new-project/fpga/sources/vhdl/topmod.vhd"]"\
 "[file normalize "$origin_dir/../../new-project/fpga/sources/system/system_wrapper.vhd"]"\
 "[file normalize "$origin_dir/../../new-project/fpga/cfg/clocks.xdc"]"\
 "[file normalize "$origin_dir/../../new-project/fpga/cfg/ports.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set script_file "basic-project.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../new-project/fpga/basic-project"]"
...
set file "$origin_dir/../../new-project/fpga/sources/vhdl/AXI_Parse.vhd"
...
set file "$origin_dir/../../new-project/fpga/sources/vhdl/axis_red_pitaya_dac.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../new-project/fpga/sources/vhdl/AXIS_Red_Pitaya_ADC.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../new-project/fpga/sources/ip/BlockMemory/BlockMemory.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/../../new-project/fpga/sources/vhdl/CustomDataTypes.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../new-project/fpga/sources/vhdl/AXI_Bus_Package.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../new-project/fpga/sources/vhdl/topmod.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../new-project/fpga/sources/system/system_wrapper.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "[file normalize "$origin_dir/../../new-project/fpga/cfg/clocks.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../new-project/fpga/cfg/clocks.xdc"
set file [file normalize $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../../new-project/fpga/cfg/ports.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../new-project/fpga/cfg/ports.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
